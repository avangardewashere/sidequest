...
This checklist tracks the remaining items from `documentation/plans/today-focus-ui-plan.md` (Section E exit criteria and Section F exit gate) before moving to the next phase.

## Source Reference

- `documentation/plans/today-focus-ui-plan.md` (lines 438-451)
- `documentation/reference/design-references/color analysis colorscheme.md`
...
- [x] References available (optional but recommended):
  - `documentation/reference/design-references/sidequest-demo.jsx` (Today / header + composition)
  - `documentation/reference/design-references/color analysis colorscheme.md` (paper, indigo CTA, ember accent, text tiers)
